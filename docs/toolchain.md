...
CI enforces `--strict --fail-under 92`, the measured `src` floor. W1 raised it from 85 as
annotated domain code landed; it never moves down without a recorded reason.
